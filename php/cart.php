...
if (!isset($_COOKIE['email'])) {
    ...
    if (isset($_GET['button'])) {
        ...
        if ($op == "Pay") {
            ...
            $api_key = '94da2fbf-5694-49d4-b6e0-1ecd0ce97b1c';
            $collection_id = 'stzugyoh';
            ...
            $data = array(
                ...
                'callback_url' => "http://localhost/cendol",
                //'redirect_url' => "https://slumberjer.com/myshopweb/php/payment_update.php?userid=$email&mobile=$mobile&amount=$amount"
                'redirect_url' => "http://localhost/cendol/php/payment_update.php?userid=$email&mobile=$mobile&amount=$amount"
            );
